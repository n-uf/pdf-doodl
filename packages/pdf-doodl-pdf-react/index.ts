 ...
 * import { usePdfAnnotations, type PdfAnnotationViewerProps } from "@n-uf/pdf-doodl-pdf-react";
 *
 * // Dynamic import for client-only component
 * const PdfAnnotationViewer = dynamic(
 *   () => import("@n-uf/pdf-doodl-pdf-react/components").then(m => m.PdfAnnotationViewer),
 *   { ssr: false }
 * );
 *
 * function App() {
...
// Note: Components must be imported from "@n-uf/pdf-doodl-pdf-react/components"
