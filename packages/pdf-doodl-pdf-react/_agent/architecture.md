...
`@n-uf/pdf-doodl-pdf-react` provides React components for PDF annotation by composing `react-pdf` with `@n-uf/pdf-doodl-react`'s annotation layer.
...
│  │  (from react-pdf)        │  │  (from @n-uf/pdf-doodl-react)      │ │
│  └──────────────────────────┘  └─────────────────────────────────────┘ │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
import { PdfAnnotationPage } from "@n-uf/pdf-doodl-pdf-react";
...
├── @n-uf/pdf-doodl (peer: types)
├── @n-uf/pdf-doodl-react (PageAnnotationLayer, PageAnnotationController)
