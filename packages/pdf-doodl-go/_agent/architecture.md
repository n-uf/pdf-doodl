...
`@n-uf/pdf-doodl-go` is a UI library for Doodl canvas drawing, following the layer architecture pattern from `@workspace/harbuz`.
...
```tsx
import { DoodleGo } from "@n-uf/pdf-doodl-go";
